/**
 * TopDaySheet
 * Bottom sheet showing transactions for the day of week with most expenses
 */
...
type Props = {
  open: boolean;
  onClose: () => void;
  topDayName: string | null;
  topDayTransactions: Transaction[];
...
export default function TopDaySheet({
  open,
  onClose,
  topDayName,
  topDayTransactions,
  ...
  if (!isVisible || !topDayName) return null;
    ...
    <div className="fixed inset-0 z-[70]">
      ...
      >
        ...
        >
          ...
          <div className="px-6 pb-4">
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {topDayTransactions.length}{" "}
              {topDayTransactions.length === 1 ? "transacción" : "transacciones"} en{" "}
        ...
        <div className="flex-1 overflow-y-auto px-6 space-y-2 min-h-0">
          {topDayTransactions.map((transaction) => {
