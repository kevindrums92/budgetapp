...
export default function PlanPage() {
  ...
  const showBudgetTabs = completedBudgets.length > 0;
    ...
    <>
      <div className="bg-gray-50 dark:bg-gray-950 min-h-screen">
        <main className="mx-auto max-w-xl px-4 pt-6 pb-28">
          {/* Budget sub-tabs (only show when there are completed budgets) */}
          {showBudgetTabs && (
              ...
              {healthCheck.exceededLimits > 0 && (
                <div className="rounded-xl bg-red-50 dark:bg-red-950/30 p-3 border border-red-200 dark:border-red-800">
                  <p className="text-sm font-medium text-red-700 dark:text-red-400">
                    {t("page.limitsExceeded", { count: healthCheck.exceededLimits })}
                  </p>
                </div>
              )}
