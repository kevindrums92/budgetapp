    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full rounded-2xl bg-white p-5 shadow-sm border-2 border-transparent hover:border-emerald-500 transition-all text-left active:scale-[0.98]"
        >
        ...
        <button
          ...
          className={`w-full rounded-2xl bg-white p-5 shadow-sm border-2 border-transparent text-left transition-all ${
            isCloudDisabled
