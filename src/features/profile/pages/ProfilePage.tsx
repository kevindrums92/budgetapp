  ...
  return (
    <div className="min-h-dvh bg-gray-50 dark:bg-gray-950 pb-28 transition-colors">
      ...
      <div className="mb-6 px-4">
        <button
          type="button"
          onClick={() => openUrl('https://www.instagram.com/kevindrums92/')}
        ...
        >
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800">
            <svg viewBox="0 0 24 24" className="h-5 w-5 text-gray-700 dark:text-gray-300" fill="currentColor">
          ...
          <div className="flex-1 min-w-0 text-left">
            <p className="text-sm font-semibold text-gray-900 dark:text-gray-50">
              {t('connect.title', 'Conéctate con el dev')}
            </p>
