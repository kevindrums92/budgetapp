...
export default function AssistantPage() {
  ...
  return (
    <div className="flex h-dvh flex-col bg-gray-950">
      {/* Header */}
      <header
        className="sticky top-0 z-10 flex shrink-0 items-center justify-between bg-gray-950 px-4 pb-3"
      ...
      >
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={handleBack}
            className="-ml-2 flex h-10 w-10 items-center justify-center rounded-full text-gray-50 active:bg-gray-800 transition-colors"
            aria-label="Volver"
          >
            <ChevronLeft size={24} />
          </button>
      ...
      <main className="flex flex-1 flex-col overflow-y-auto">
        ...
        {isOnline && flowState === "idle" && (
          <div className="my-auto flex flex-col items-center px-6 py-8">
            ...
            {/* Title */}
            <h2 className="mb-3 text-center text-2xl font-extrabold tracking-tight text-gray-50">
              {t("assistant.greeting")}
            </h2>

            {/* Subtitle */}
            <p className="mb-8 max-w-[300px] text-center text-sm leading-relaxed text-gray-400">
            ...
            <div className="mb-6 flex w-full max-w-sm flex-col gap-2">
              <button
                ...
                className="flex items-center gap-3 rounded-2xl bg-gray-900 px-4 py-3 text-left transition-all active:scale-[0.98]"
              >
                <Type size={16} className="shrink-0 text-gray-500" />
              ...
              <button
                ...
                className="flex items-center gap-3 rounded-2xl bg-gray-900 px-4 py-3 text-left transition-all active:scale-[0.98]"
              >
                <Camera size={16} className="shrink-0 text-gray-500" />
                <span className="text-sm text-gray-300">
              ...
              <button
                ...
                className="flex items-center gap-3 rounded-2xl bg-gray-900 px-4 py-3 text-left transition-all active:scale-[0.98]"
              >
                <Mic size={16} className="shrink-0 text-gray-500" />
                <span className="text-sm text-gray-300">
        ...
        {isOnline && flowState === "processing" && (
          <div className="my-auto flex flex-col items-center px-6 py-8">
            ...
            <p className="mb-4 text-base font-medium text-gray-50">
        ...
        {isOnline && flowState === "error" && (
          <div className="my-auto flex flex-col items-center px-6 py-8">
            ...
            {error === "RATE_LIMIT_FREE" && !rewardedWasConsumed ? null : (
              <>
                <div className="mb-4 rounded-xl bg-red-900/20 p-4">
                ...
                <button
                  type="button"
                  onClick={handleRetry}
                  className="rounded-xl bg-gray-800 px-6 py-2 text-sm font-medium text-gray-300"
                >
                  {t("common.retry")}
                </button>
              </>
        ...
        {isOnline && flowState === "success" && (
          <div className="my-auto flex flex-col items-center px-6 py-8">
            <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-emerald-900/50">
