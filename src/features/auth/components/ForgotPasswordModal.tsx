        ...
        {!emailSent ? (
          <>
            ...
            <p className="mb-4 text-sm text-gray-600 dark:text-gray-400 text-center">
              {t('auth.forgotPassword.message', 'Ingresa tu email y te enviaremos un link para restablecer tu contraseña')}
            </p>
            ...
            <div className="flex gap-3">
              ...
              >
                {isLoading ? (
                  ...
                  t('auth.forgotPassword.send', 'Enviar link')
                )}
              </button>
            </div>
          </>
          ...
          <>
            {/* Success Icon */}
            <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100 dark:bg-emerald-900/30 mx-auto">
              <CheckCircle2 className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />
            </div>

            {/* Success Title */}
            <h3 className="mb-2 text-lg font-semibold text-gray-900 dark:text-gray-50 text-center">
              {t('auth.forgotPassword.emailSent', '¡Email enviado!')}
            </h3>

            {/* Success Message */}
            <p className="mb-4 text-sm text-gray-600 dark:text-gray-400 text-center">
              {t('auth.forgotPassword.checkInbox', 'Revisa tu bandeja de entrada y sigue el link para restablecer tu contraseña')}
            </p>
            ...
            >
              {t('auth.forgotPassword.close', 'Entendido')}
            </button>
          </>
        )}
      </div>
