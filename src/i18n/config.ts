...
i18n
  ...
  .init({
    ...
    fallbackLng: 'es',
    defaultNS: 'common',
    ns: ['common', 'onboarding', 'profile', 'home', 'budget', 'stats', 'trips', 'transactions', 'categories', 'backup', 'scheduled', 'history', 'legal', 'notifications', 'paywall', 'batch', 'tour', 'assistant'],
    interpolation: {
