-- =====================================================
-- Add SECURITY DEFINER function for upserting push tokens
-- =====================================================
-- This function bypasses RLS to allow token takeover between users
-- on the same device (FCM tokens are device-specific, not user-specific)
