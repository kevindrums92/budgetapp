...
- [ ] al entrar en el detalle de una categoria(CategoryMonthDetailPage) desde la pagina de stats. aparece scrolleado hacia abajo! y por ende se ve cortado el icono. deberia siempre aparecer con scroll en la posicion 0.
